...
class Homemodel {
  ...
  User user;
  HomemodelCoverPhoto coverPhoto;
  ...
  factory Homemodel.fromJson(Map<String, dynamic> json) => Homemodel(
    ...
    coverPhoto: HomemodelCoverPhoto.fromJson(json["cover_photo"]),
...
class HomemodelCoverPhoto {
  ...
  factory HomemodelCoverPhoto.fromJson(Map<String, dynamic> json) => HomemodelCoverPhoto(
    id: json["id"],
    slug: json["slug"],
